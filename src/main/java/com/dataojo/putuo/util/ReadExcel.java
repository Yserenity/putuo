    ...
    public static List readExcel(String path,String strURL) {
        ...
        try {
            ...
            for (int i = 1; i < sheet.getRows(); i++) {
                ...
                position.setAddress(sheet.getCell(3, i).getContents().split("【")[0]);
                position.setTime(sheet.getCell(4,i).getContents());
                position.setCount(sheet.getCell(5,i).getContents());
                // 获取第二列的第 i 行信息
